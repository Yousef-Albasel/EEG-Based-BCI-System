...
def train(X_train, y_train, X_val, y_val, save_dir=None):
    scalers = {
    ...
    for scaler_name, scaler in scalers.items():
        ...
        for name, (model, params) in models.items():
            ...
            grid = GridSearchCV(model, params, cv=5, scoring='accuracy', n_jobs=2)
        ...
        print(f"\n Best Model for {scaler_name}: {best_model_name} ({best_score:.4f})")
        print("-" * 60)
